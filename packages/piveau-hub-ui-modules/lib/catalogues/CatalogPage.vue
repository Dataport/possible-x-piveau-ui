      ...
      <slot name="header">
        <div class="catalog-header-container mx-auto d-flex justify-content-between align-items-center" ref="catHeader">
          <div class="catalog-header-info d-flex">
            <img v-if="showArray(getCatalog.catalogueFavIcon)" class="catalog-header-title-icon" :src="getCatalog.catalogueFavIcon" alt="">
          ...
          <img v-if="showArray(getCatalog.catalogueLogo)" class="catalog-header-logo d-none d-sm-block" :src="getCatalog.catalogueLogo" alt="" aria-label="logo">
        </div>
      </slot>
      ...
      <div class="catalog-card card" >
        ...
        <div class="card-body my-5">
          ...
          <div v-if="activeTabName === 'about'" class="tab-pane active catalog-about-tab d-flex align-items-start justify-content-between" id="about" role="tabpanel">
            ...
            <img v-if="showArray(getCatalog.catalogueProfile)" class="catalog-hero-pic img-fluid" :src="getCatalog.catalogueProfile" alt="">
          </div>
