...
const dcatapProperties = {
  datasets: {
    ...
    versionNotes: {
      ...
      class: 'property besides langDescriptionInput',
      repeatable: true,
      '@repeatableRemoved': true,
      children: [
        {
          ...
          type: 'textarea',
          name: '@value',
          class: 'main inputTextfield w-100',
          '@change': true,
        },
        {
          identifier: 'language',
    ...
    accessService: {
      ...
      children: [
        ...
        },
        {
          ...
          type: 'group',
          name: 'dct:title',
          class: 'property besides langStringInput',
          '@change': true,
          repeatable: true,
          '@repeatableRemoved': true,
          children: [
            {
              ...
              type: 'text',
              name: '@value',
              class: 'main w-100 inputTextfield',
              '@change': true,
            },
            {
              identifier: 'language',
