<template>
    <div class="dsd-distribution-quality">
        ...
        <div class="content">
            <div class="box" v-for="(distribution, index) in qualityDistributions" :key="index">
                ...
                <div class="box-content" v-if="!distribution.collapsed">
                    <div class="dsd-distribution-quality-property" v-for="(el, index) in distributionQualityProperties" :key="index">
                        <h4>{{ el }}</h4>
