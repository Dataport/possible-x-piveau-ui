<template>
    <div class="container-fluid catalogs content">
        <h1 class="row col-12 page-title text-primary ec-ds-title">{{ $t('message.header.navigation.data.catalogs') }}
        </h1>
        <div class="row">
            ...
            <section class="col-md col-12">
                        ...
                        <div class="col">
                            <div class="input-group">
                                <input type="text" class="form-control rounded-lg ds-input ec-ds-search"
                                    ...
                                    :placeholder="$t('message.catalogs.searchBar.placeholder')" v-model="query"
                                ...
                                <div class="d-flex cursor-pointer">
                                    ...
                                    <div class="btn-group ec-ds-scope-dropdown" role="group">
                                        <button
                                            ...
                                            id="btnGroupDrop2" type="button" data-toggle="dropdown"
                                            aria-expanded="false">
                                            <div
                                                class="pl-2 h-100 d-flex align-items-center font-weight-bold ec-ds-scope-text">
                                ...
                                <div class="input-group-append ec-ds-search-button-container">
                                    <button
                                        class="btn btn-sm btn-primary d-flex align-items-center ds-input ec-ds-search-btn"
                                        type="button" @click="changeQuery(query)">
                                ...
                                <div class="suggestion-list-group" v-if="autocompleteData.show">
                                    <ul class="list-group suggestion-list">
                                        <button class="list-group-item list-group-item-action"
                                            v-for="(suggestion) in autocompleteData.suggestions" :key="suggestion.id"
                                            @click="handleSuggestionSelection(suggestion)">
                                            {{ getTranslationFor(suggestion.title, $route.query.locale,
                ...
                <pv-data-info-box v-for="catalog in getCatalogs" :key="`data-info-box@${catalog.id}`" catalog-mode
                    ...
                    :src="getImg(getCatalogImage(catalog))" :dataset="{
                      ...
                      updatedDate: null,
                      formats: [],
                    }" :description-max-length="1000" :data-cy="`catalog@${catalog.id}`" class="mt-3" />
