    ...
    <div class="input-group">
      <div class="input-group-prepend">
        ...
        <input class="form-control round"
              type="text"
              :placeholder="`${$t('message.header.subnav.search')} ${selected === 'site' ? $t('message.header.searchOptions.siteContent') : $t('message.header.searchOptions.datasets')} ...`"
              v-model="q">
      </div>
      ...
      <div class="input-group-append ">
        <app-link
          ref="searchButton"
          class="btn-search round-right deu-btn deu-btn--primary"
          :path="searchPath"
        >
