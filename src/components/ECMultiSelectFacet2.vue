<template>
  <div class="row">
    <label for="select-multiple" class="ecl-form-label">
      Select a country<span class="ecl-form-label__required">*</span>
    </label>
    <div class="ecl-help-block">This is the input&#x27;s helper text.</div>
    <div class="ecl-select__container ecl-select__container--m  w-100" ref="mscontainer">
      <select class="ecl-select" id="select-multiple"
            required="" multiple="" data-ecl-auto-init="Select" data-ecl-auto-initialized="true" data-ecl-select-multiple=""
...
<script>
import Select from "@/ecl/ec-select";

export default {
  name: "ECMultiSelectFacet",
  mounted() {
    Select.autoInit(this.$refs.mscontainer);
  }
}
</script>
