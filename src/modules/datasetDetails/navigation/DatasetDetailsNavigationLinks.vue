...
<script>
import DatasetDetailsFeedbackButton from "@/modules/datasetDetails/DatasetDetailsFeedbackButton";
import AppLink from "@/modules/widgets/AppLink";
import DatasetDetailsShareButton from "@/modules/datasetDetails/DatasetDetailsShareButton";
...
export default {
  ...
  metaInfo() {
    return {
      link: [{
        rel: 'alternate', type: 'application/rss+xml', title: `${this.$env.title} - ${this.getTranslationFor(this.getTitle, this.$route.query.locale, this.getLanguages)}`, href: `https://piveau-hub-search-data-europa-eu.apps.osc.fokus.fraunhofer.de/de/feeds/datasets/${this.getID}.rss`,
      }],
    };
  },
  mounted() {
